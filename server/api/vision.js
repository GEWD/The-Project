...
exports.spliceReceipt = function(receiptArray) {
  ...
  var checkPricesAddToTotal = function() {
    ...
    if (totalPrice !== accumPrice) {
      itemToPriceObj['<NOTE>'] = 'We apologize for the inconvenience, our <strike>sick</strike> algorithm may not have accurately parsedx your receipt. You can utilize the delete and add items buttons to adjust the results and to remove this note';
    }
  };
